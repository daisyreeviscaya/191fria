...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { body: @announcement.body, key: @announcement.key, title: @announcement.title } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { body: @announcement.body, key: @announcement.key, title: @announcement.title } }
